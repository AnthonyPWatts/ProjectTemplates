...
# Steps once you've made and tested some improvement to an existing published package:
    ...
    # 2. Confirm clean slate (i.e. only the core templates) with 'dotnet new -l'
    
    # 3. Install package for use by dotnet new from local source by pointing to a parent folder, e.g.
    ...
    # 7. Edit the nuspec file as appropriate, e.g. at minimum version uplift
    
    # 8. NuGet pack with nuget.exe pack .\anthonypwatts.templates.mvc.nuspec -OutputDirectory .\nupkg
